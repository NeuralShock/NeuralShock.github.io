...
!(function (e) {
    ...
    function c(e, t) {
      for (var n = {}, o = [], i = 0; i < e.length; i++) {
        ...
        -1 !== d
          ...
          : r.push({ identifier: u, updater: y(f, t), references: 1 }),
          o.push(u);
      }
      return o;
    }
  ...
  function (e, t, n) {
    (t = n(4)(!1)).push([
      e.i,
      ".simple-tree-table-icon{display:inline-block;width:1.5em;line-height:1.5em;margin:0.1em;background-color:var(--bs-primary);color:var(--bs-white);border:1em;border-radius:5px;text-align:center;cursor:pointer}.simple-tree-table-opened .simple-tree-table-icon:after{content:'-'}.simple-tree-table-closed .simple-tree-table-icon:after{content:'+'}\n",
      "",
    ]),
      (e.exports = t);
  },
  ...
  function (e, t, n) {
    ...
    var c = (function () {
        function e() {
          ...
          a(this, e),
            (this.opts = { type: t.type || "session", key: t.key }),
    ...
    var h = {
      ...
      p = (function () {
        function e(t) {
          ...
          d(this, e),
            (this.options = i.a.extend({}, h, n)),
            (this.$table = i()(t)),
            (this.$expander = i()(this.options.expander)),
            (this.$collapser = i()(this.options.collapser)),
            this.options.store &&
              this.options.storeKey &&
              (this.store = new c({
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                this.$table.removeClass(e),
                  this.nodes().removeClass(e),
                  this.$table.find(".".concat(u, "-icon")).remove(),
                  this.unbind();
              },
            },
            {
                ...
                this.nodes()
                  ...
                  this.nodes()
                    .filter(function (t, n) {
                      return (
                        0 ==
                        i()(n)
                          .find(e.options.iconPosition)
                          .find(".".concat(u, "-handler")).length
                      );
                    })
                    .each(function (t, n) {
                      var o = i()(n),
                        ...
                        s = i()(e.options.iconTemplate)
                          .addClass(
                            "".concat(u, "-handler ").concat(u, "-icon")
                          )
                          .css("margin-left", "".concat(r, "px"));
                  ...
                  this.nodes()
                    ...
                    .each(function (t, n) {
                      ...
                      e.hasChildren(o)
                        ? e.opensDefault(o)
                          ? o.addClass("".concat(u, "-opened"))
                          : o.addClass("".concat(u, "-closed"))
                        : o.addClass("".concat(u, "-empty"));
                    }),
                  this.nodes()
                    .filter(".".concat(u, "-opened"))
                    .each(function (t, n) {
                      e.show(i()(n));
                    }),
                  this.nodes()
                    .filter(".".concat(u, "-closed"))
                    .each(function (t, n) {
                      e.hide(i()(n));
                    });
              },
            ...
            },
            {
              key: "unbind",
              value: function () {
                this.$expander.off(".".concat(u)),
                  this.$collapser.off(".".concat(u)),
                  this.$table.off(".".concat(u, " node:open node:close"));
              },
            },
            {
              key: "expand",
            ...
            },
            {
              key: "show",
              value: function (e) {
                e.hasClass("".concat(u, "-empty")) ||
                  (e
                    .removeClass("".concat(u, "-closed"))
                    .addClass("".concat(u, "-opened")),
                  this.showDescs(e));
              },
            },
            {
              ...
              value: function (e) {
                ...
                this.findChildren(e).each(function (e, n) {
                  var o = i()(n);
                  o.show(),
                    o.hasClass("".concat(u, "-opened")) && t.showDescs(o);
                });
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                e.hasClass("".concat(u, "-empty")) ||
                  (e
                    .removeClass("".concat(u, "-opened"))
                    .addClass("".concat(u, "-closed")),
                  this.hideDescs(e));
              },
            },
            {
